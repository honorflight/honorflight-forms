  ...
  grunt.initConfig({
    ...
    copy: {
      main: {
        files: [
          {src: ['img/**'], dest: 'dist/'},
          {src: ['bower_components/font-awesome/fonts/**'], dest: '../honorflight-forms-plugin/dist/',filter:'isFile',expand:true},
          {src: ['bower_components/bootstrap/fonts/**'], dest: '../honorflight-forms-plugin/dist/',filter:'isFile',expand:true}
